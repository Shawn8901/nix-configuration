...
###############################################################################
#
# Copied from Mic92s deploy_nixos.py
# https://github.com/Mic92/dotfiles/blob/master/deploy_nixos.py
#
###############################################################################
...
class DeployHost:
        ...
        while len(rlist) != 0:
            ...
            if print_fd in r:
                ...
                if read == "" or "\n" in print_buf:
                    ...
                    for line in lines:
                        print(f"[\033[95m{self.command_prefix}\033[0m] {line}")
                    print_buf = ""
    ...
    def run_local(
        ...
        print(f"[\033[95m{self.command_prefix}\033[0m] {cmd}")

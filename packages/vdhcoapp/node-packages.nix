...
let
  sources = {
    "@babel/runtime-7.17.9" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "lSiBBvodq29uShpWGNbgFdKYNiFDo5/HIYsaCEY9ff4sb10x9jizo2+pRrSyF4jKZCXqgzuqBOQKbUm90gQwJg==";
      };
    };
    ...
    "@types/node-17.0.33" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "miWq2m2FiQZmaHfdZNcbpp9PuXg34W5JZ5CrJ/BaS70VuhoJENBEQybeiYSaPBRNq6KQGnjfEnc/F3PN++D+XQ==";
      };
    };
    ...
    "caw-2.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "Cg8/ZSBEa8ZVY9HspcGUYaK63d/bN7rqS3CYCzEGUxuYv6UlmcjzDUz2fCFFHyTvUW5Pk0I+3hkA3iXlIj6guA==";
      };
    };
    "chalk-3.0.0" = {
      name = "chalk";
    ...
    "date-format-4.0.10" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "RuMIHocrVjF84bUSTcd1uokIsLsOsk1Awb7TexNOI3f48ukCu39mjslWquDTA08VaDMF2umr3MB9ow5EyJTWyA==";
      };
    };
    "debug-4.3.4" = {
      name = "debug";
    ...
    "download-6.2.5" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "DpO9K1sXAST8Cpzb7kmEhogJxymyVUd5qz/vCOSyvwtp2Klj2XcDt5YUuasgxka44SxF0q5RriKIwJmQHG2AuA==";
      };
    };
    "duplexer3-0.1.4" = {
      name = "duplexer3";
    ...
    "ext-list-2.2.2" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "u+SQgsubraE6zItfVA0tBuCBhfU9ogSRnsvygI7wht9TS510oLkBRXBsqopeUG/GBOIQyKZO9wjTqIu/sf5zFA==";
      };
    };
    "ext-name-5.0.0" = {
      name = "ext-name";
      ...
      src = fetchurl {
        ...
        sha512 =
          "yblEwXAbGv1VQDmow7s38W77hzAgJAO50ztBLMcUyUBfxv1HC+LGwtiEN+Co6LtlqT/5uwVOxsD4TNIilWhwdQ==";
      };
    };
    "extend-3.0.2" = {
      name = "extend";
    ...
    "filenamify-2.1.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "ICw7NTT6RsDp2rnYKVd8Fu4cr6ITzGy3+u4vUujPkabyaz+03F24NWEX7fs5fp+kBonlaqPH8fAO2NM+SXt/JA==";
      };
    };
    "flatted-3.2.5" = {
      name = "flatted";
    ...
    "foreachasync-3.0.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/foreachasync/-/foreachasync-3.0.0.tgz";
    ...
    "get-proxy-2.1.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "zmZIaQTWnNQb4R4fJUEp/FC51eZsc6EkErspy3xtIYStaq8EB/hDIWipxsal+E8rz0qD7f2sL/NA9Xee4RInJw==";
      };
    };
    "get-stream-2.3.1" = {
      name = "get-stream";
    ...
    "glob-7.2.2" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "NzDgHDiJwKYByLrL5lONmQFpK/2G78SMMfo+E9CuGlX4IkvfKDsiQSNPwAYxEy+e6p7ZQ3uslSLlwlJcqezBmQ==";
      };
    };
    "glob-parent-3.1.0" = {
      name = "glob-parent";
    ...
    "got-11.8.3" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "7gtQ5KiPh1RtGS9/Jbv1ofDpBFuq42gyfEib+ejaRBJuj/3tQFeR5+gw57e4ipaU8c/rCjvX6fkQz2lyDlGAOg==";
      };
    };
    "got-7.1.0" = {
      name = "got";
    ...
    "keyv-4.2.8" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "IZZo6krhHWPhgsP5mBkEdPopVPN/stgCnBVuqi6dda/Nm5mDTOSVTrFMkWqlJsDum+B0YSe887tNxdjDWkO7aQ==";
      };
    };
    "lazystream-1.0.1" = {
      name = "lazystream";
    ...
    "log4js-6.4.7" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "q/9Eyw/hkvQ4e9DNHLbK2AfuDDm5QnNnmF022aamyw4nUnVLQRhvGoryccN5aEI4J/UcA4W36xttBCrlrdzt2g==";
      };
    };
    ...
    "now-and-later-2.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "KGvQ0cB70AQfg107Xvs/Fbu+dGmZoTRJp2TaPwcwQm3/7PteUyN2BCgk8KBMPGBUXZdVwyWS8fDCGFygBm19UQ==";
      };
    };
    "npm-conf-1.1.3" = {
      name = "npm-conf";
    ...
    "pkg-fetch-2.7.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "0def00dVQwQ4F2sn2E1Mw0/vNXkujEf+X6I1h5NbbBYKOoJ5esy7LKJyxmzChQy6kwOPfTMH2E+2iTqWUhRHVA==";
      };
    };
    "prepend-http-1.0.4" = {
      name = "prepend-http";
    ...
    "remove-bom-buffer-3.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "8v2rWhaakv18qcvNeli2mZ/TMTL2nEyAKRvzo1WtnZBl15SHyEhrCu2/xKlJyUFKHiHgfXIyuY6g2dObJJycXQ==";
      };
    };
    ...
    "streamroller-3.0.9" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/streamroller/-/streamroller-3.0.9.tgz";
        sha512 =
          "Y46Aq/ftqFP6Wb6sK79hgnZeRfEVz2F0nquBy4lMftUuJoTiwKa6Y96AWAUGV1F3CjhFark9sQmzL9eDpltkRw==";
      };
    };
    ...
    "strip-outer-1.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "k55yxKHwaXnpYGsOzg4Vl8+tDrWylxDEpknGjhTiZB8dFRU5rTo9CAzeycivxV3s+zlTKwrs6WxMxR95n26kwg==";
      };
    };
    ...
    "vinyl-fs-3.0.3" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "vIu34EkyNyJxmP0jscNzWBSygh7VWhqun6RmqVfXePrOwi9lhvRs//dOaGOTRUQr4tx7/zd26Tk5WeSVZitgng==";
      };
    };
    ...
    "walk-2.3.15" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "4eRTBZljBfIISK1Vnt69Gvr2w/wc3U6Vtrw7qiN5iqYJPH7LElcYh/iU4XWhdCy2dZqv1ToMyYlybDylfG/5Vg==";
      };
    };
    "wrappy-1.0.2" = {
      name = "wrappy";
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."download-6.2.5" // { dependencies = [ sources."got-7.1.0" ]; })
      ...
      (sources."fs.extra-1.3.2" // {
        dependencies = [ sources."fs-extra-0.6.4" sources."jsonfile-1.0.1" ];
      })
      ...
      (sources."pkg-fetch-2.7.0" // {
        dependencies = [ sources."fs-extra-8.1.0" ];
      })
      ...
      (sources."responselike-2.0.0" // {
        dependencies = [ sources."lowercase-keys-2.0.0" ];
      })
      sources."rfdc-1.3.0"
